...
const InputAnswer = ({ refInput, selected, changeHandler}) => <input ref={refInput} type='text' name='answer' value={selected} onChange={changeHandler} placeholder='Type your answer' autoComplete='off' />;
    ...
    <CardComponent>
      ...
      <ControlDiv>
        {data.type === 'selection' ? 
          ...
          : 
          <InputAnswer refInput={refInput} selected = {selected}  changeHandler={changeHandler} />
        }
      </ControlDiv>
